...
export function loadModel() {
  if (!modelPromise) {
    modelPromise = tf.loadLayersModel(MODEL_URL).catch(() => {
      modelPromise = null;
      throw new Error(
        "The screening model could not be loaded. Convert the Keras model to TensorFlow.js and place it at public/models/conjuctiva."
      );
    });
  }
