...
const MODEL_URL = "/models/conjuctiva.tflite";
  ...
  if (!modelPromise) {
    modelPromise = import("@tensorflow/tfjs-tflite/dist/tf-tflite.es2017.js")
      ...
      .catch((error) => {
        ...
        modelPromise = null;
        throw new Error(
          "The screening model could not be loaded. Ensure the converted TFLite model is available at /models/conjuctiva.tflite."
        );
      });
  }
